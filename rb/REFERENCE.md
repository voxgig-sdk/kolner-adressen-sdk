# KolnerAdressen Ruby SDK Reference

Complete API reference for the KolnerAdressen Ruby SDK.
...
#### `KolnerAdressenSDK.test(testopts = nil, sdkopts = nil)`
...
```ruby
results, err = client.Address.list(nil)
```
