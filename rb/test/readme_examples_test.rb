...
#      offline in seeded test mode (KolnerAdressenSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "KolnerAdressen_sdk.rb")
  SDK_CLASS = "KolnerAdressenSDK"
