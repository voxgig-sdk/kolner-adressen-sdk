...
from kolneradressen_sdk.kolneradressen_types import (
    DatastoreSearch,
...
class DatastoreSearchEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return DatastoreSearchEntity(self._client, opts)
    ...
    def data_get(self) -> DatastoreSearch:
    ...
    def match_get(self) -> DatastoreSearch:
    ...
    def load(self, reqmatch=None, ctrl=None) -> DatastoreSearch:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.DatastoreSearch().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
