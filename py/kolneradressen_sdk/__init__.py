...
from kolneradressen_sdk.utility import register
...
class KolnerAdressenSDK:
    ...
    def get_utility(self):
        return KolnerAdressenUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("KolnerAdressenSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Address(self, data=None) -> "AddressEntity":
        ...
        from kolneradressen_sdk.entity.address_entity import AddressEntity
    ...
    def DatastoreSearch(self, data=None) -> "DatastoreSearchEntity":
        ...
        from kolneradressen_sdk.entity.datastore_search_entity import DatastoreSearchEntity
