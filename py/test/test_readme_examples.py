# KolnerAdressen SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions KolnerAdressenSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both KolnerAdressenSDK(...) and KolnerAdressenSDK.test(...) become
#      KolnerAdressenSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "kolneradressen_sdk"
_SDK_CLASS = "KolnerAdressenSDK"
