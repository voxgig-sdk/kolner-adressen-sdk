...
func registerSDKWords(r *eng.Registry, client *sdk.KolnerAdressenSDK) {
...
func runOp(client *sdk.KolnerAdressenSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
