// Command KolnerAdressen-cli is a CLI + REPL for the KolnerAdressen SDK,
...
const prompt = "kolner-adressen"

// entitiesHelp is the space-separated entity list shown by /help.
const entitiesHelp = "address datastore_search"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      KOLNER_ADRESSEN_APIKEY (api key), KOLNER_ADRESSEN_BASE (base url override)")
