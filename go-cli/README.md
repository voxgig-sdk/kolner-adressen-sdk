...
AQL-driven CLI and REPL for the KolnerAdressen SDK. Positional arguments are
...
```sh
go build -o kolner-adressen-cli ./...
```
...
./kolner-adressen-cli load 1 address
./kolner-adressen-cli load '{id:1}' address
