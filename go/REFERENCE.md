# KolnerAdressen Golang SDK Reference

Complete API reference for the KolnerAdressen Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *KolnerAdressenSDK`
...
#### `Address(data map[string]any) KolnerAdressenEntity`

Create a new `Address` entity instance. Pass `nil` for no initial data.

#### `DatastoreSearch(data map[string]any) KolnerAdressenEntity`

Create a new `DatastoreSearch` entity instance. Pass `nil` for no initial data.
