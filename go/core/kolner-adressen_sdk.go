...
func (sdk *KolnerAdressenSDK) OptionsMap() map[string]any {
...
func (sdk *KolnerAdressenSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *KolnerAdressenSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *KolnerAdressenSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *KolnerAdressenSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *KolnerAdressenSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *KolnerAdressenSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("KolnerAdressenSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *KolnerAdressenSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *KolnerAdressenSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("KolnerAdressenSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *KolnerAdressenSDK {
	...
	sdk := NewKolnerAdressenSDK(sdkopts)
	sdk.Mode = "test"
