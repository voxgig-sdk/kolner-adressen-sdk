...
type DatastoreSearchEntity struct {
	name    string
	client  *core.KolnerAdressenSDK
...
func NewDatastoreSearchEntity(client *core.KolnerAdressenSDK, entopts map[string]any) *DatastoreSearchEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DatastoreSearchEntity) GetName() string { return e.name }
...
func (e *DatastoreSearchEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DatastoreSearchEntity) Deleted() bool {
	return e.deleted
}


func (e *DatastoreSearchEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDatastoreSearchEntity(e.client, opts)
}

func (e *DatastoreSearchEntity) Data(args ...any) any {
...
func (e *DatastoreSearchEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an DatastoreSearch; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DatastoreSearchEntity) DataTyped(data ...DatastoreSearch) DatastoreSearch {
	if len(data) > 0 {
		return typedFrom[DatastoreSearch](e.Data(asMap(data[0])))
	}
	return typedFrom[DatastoreSearch](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through DatastoreSearch (all fields
// optional at the wire level).
func (e *DatastoreSearchEntity) MatchTyped(match ...DatastoreSearch) DatastoreSearch {
	if len(match) > 0 {
		return typedFrom[DatastoreSearch](e.Match(asMap(match[0])))
	}
	return typedFrom[DatastoreSearch](e.Match())
}
...
func (e *DatastoreSearchEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DatastoreSearchEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DatastoreSearchLoadMatch and returns an DatastoreSearch. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *DatastoreSearchEntity) LoadTyped(reqmatch DatastoreSearchLoadMatch, ctrl map[string]any) (DatastoreSearch, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return DatastoreSearch{}, err
	}
	return typedFrom[DatastoreSearch](res), nil
}



func (e *DatastoreSearchEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *DatastoreSearchEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *DatastoreSearchEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *DatastoreSearchEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *DatastoreSearchEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
