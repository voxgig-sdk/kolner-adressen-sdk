...
// instead of `sdk.NewKolnerAdressenSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *KolnerAdressenSDK  { return NewKolnerAdressenSDK(nil) }
func Test() *KolnerAdressenSDK { return TestSDK(nil, nil) }
