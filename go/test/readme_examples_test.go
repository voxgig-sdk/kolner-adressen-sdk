...
const testSeed = `map[string]any{"entity": map[string]any{"address": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "datastore_search": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
