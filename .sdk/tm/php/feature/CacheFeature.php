...
// KolnerAdressen SDK cache feature
...
class KolnerAdressenCacheFeature extends KolnerAdressenBaseFeature
{
    ...
    private function _through(KolnerAdressenContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
