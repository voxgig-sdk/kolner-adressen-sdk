...
// KolnerAdressen SDK timeout feature
...
class KolnerAdressenTimeoutFeature extends KolnerAdressenBaseFeature
{
    ...
    private function _with_timeout(KolnerAdressenContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(KolnerAdressenContext $_ctx, float $ms): void
    {
        $client = $this->client;
