...
// KolnerAdressen SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class KolnerAdressenTestFeature extends KolnerAdressenBaseFeature
{
    ...
    public function init(KolnerAdressenContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (KolnerAdressenContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = KolnerAdressenParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (KolnerAdressenContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(KolnerAdressenContext $ctx, $op, $args): array
    {
        ...
        foreach ($keys as $k) {
            ...
            if ($is_id || $in_reqd) {
                $v = KolnerAdressenParam::call($ctx, $k);
