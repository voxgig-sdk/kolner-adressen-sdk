...
// KolnerAdressen SDK rbac feature
...
class KolnerAdressenRbacFeature extends KolnerAdressenBaseFeature
{
    ...
    private function _required(KolnerAdressenContext $ctx): ?string
    {
    ...
    private function _reject(KolnerAdressenContext $ctx, string $required): void
    {
    ...
    private function _track(KolnerAdressenContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
