...
// KolnerAdressen SDK pipeline test
//
...
{
    private static function utility(): KolnerAdressenUtility
    {
        return new KolnerAdressenUtility();
    }
    ...
    private static function ctx(array $over = []): KolnerAdressenContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new KolnerAdressenContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new KolnerAdressenOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof KolnerAdressenError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new KolnerAdressenOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = KolnerAdressenMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new KolnerAdressenOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = KolnerAdressenMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new KolnerAdressenOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = KolnerAdressenMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new KolnerAdressenSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = KolnerAdressenMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new KolnerAdressenResponse([]),
            'result' => new KolnerAdressenResult([]),
        ]);
        [, $err] = KolnerAdressenMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new KolnerAdressenSpec([]),
            'response' => null,
            'result' => new KolnerAdressenResult([]),
        ]);
        [, $err] = KolnerAdressenMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new KolnerAdressenSpec(['step' => 's']),
            'response' => new KolnerAdressenResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new KolnerAdressenResult([]),
        ]);
        [, $err] = KolnerAdressenMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new KolnerAdressenSpec(['step' => 's']),
            'response' => new KolnerAdressenResponse(self::resp(200, ['v' => 1])),
            'result' => new KolnerAdressenResult([]),
        ]);
        [, $err] = KolnerAdressenMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new KolnerAdressenSpec(['step' => 's']),
            'response' => new KolnerAdressenResponse(self::resp(200, ['v' => 2])),
            'result' => new KolnerAdressenResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        KolnerAdressenMakeResponse::call($ctx);
    ...
    {
        $preset = new KolnerAdressenResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new KolnerAdressenSpec([]),
            'response' => new KolnerAdressenResponse([]),
            'result' => new KolnerAdressenResult([]),
        ...
        [$got, $err] = KolnerAdressenMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new KolnerAdressenResult([])]);
        [, $err] = KolnerAdressenMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new KolnerAdressenSpec([]), 'result' => null]);
        [, $err] = KolnerAdressenMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new KolnerAdressenSpec(['step' => 's']),
            'result' => new KolnerAdressenResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new KolnerAdressenOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = KolnerAdressenMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new KolnerAdressenSpec(['step' => 's']),
            'result' => new KolnerAdressenResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new KolnerAdressenOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = KolnerAdressenMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new KolnerAdressenResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new KolnerAdressenSpec([]),
            'result' => new KolnerAdressenResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = KolnerAdressenMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = KolnerAdressenMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new KolnerAdressenError('boom', 'boom');
        $utility->fetcher = function (KolnerAdressenContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new KolnerAdressenSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = KolnerAdressenMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (KolnerAdressenContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = KolnerAdressenMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(KolnerAdressenResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        KolnerAdressenMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (KolnerAdressenContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new KolnerAdressenSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = KolnerAdressenMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new KolnerAdressenResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new KolnerAdressenSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = KolnerAdressenMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = KolnerAdressenMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = KolnerAdressenMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new KolnerAdressenResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, KolnerAdressenDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new KolnerAdressenResult(['ok' => false])]);
        $this->expectException(KolnerAdressenError::class);
        KolnerAdressenDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new KolnerAdressenResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', KolnerAdressenMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        KolnerAdressenMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new KolnerAdressenBaseFeature();
        $b = new KolnerAdressenBaseFeature();
        KolnerAdressenFeatureAdd::call($ctx, $a);
        KolnerAdressenFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): KolnerAdressenBaseFeature
    {
        $f = new KolnerAdressenBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        KolnerAdressenFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): KolnerAdressenContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new KolnerAdressenSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = KolnerAdressenPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        KolnerAdressenPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new KolnerAdressenResponse(['headers' => null]),
            'result' => new KolnerAdressenResult([]),
        ]);
        KolnerAdressenResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        KolnerAdressenResultBody::call($ctx);
