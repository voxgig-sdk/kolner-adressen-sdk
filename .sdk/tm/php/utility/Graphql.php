...
// KolnerAdressen SDK utility: graphql
//
...
class KolnerAdressenGraphql
{
    ...
    // equivalent.
    public static function body(KolnerAdressenContext $ctx): mixed
    {
    ...
    public static function errors(KolnerAdressenContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
