...
// KolnerAdressen SDK utility: fetcher

class KolnerAdressenFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; KolnerAdressenSDK/1.0)';
    ...
    public static function call(KolnerAdressenContext $ctx, string $fullurl, array $fetchdef): array
    {
