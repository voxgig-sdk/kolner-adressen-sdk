...
// KolnerAdressen SDK utility type

class KolnerAdressenUtility
{
    ...
    public static function copy(KolnerAdressenUtility $src): KolnerAdressenUtility
    {
        $u = new KolnerAdressenUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
