...
from projectname_sdk.core.control import KolnerAdressenControl
...
class KolnerAdressenContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = KolnerAdressenControl()
        ...
        if isinstance(sp, KolnerAdressenSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, KolnerAdressenResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, KolnerAdressenResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return KolnerAdressenOperation({})
    ...
    def make_error(self, code, msg):
        return KolnerAdressenError(code, msg, self)
