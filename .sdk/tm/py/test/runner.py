...
class KolnerAdressenTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = KolnerAdressenTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = KolnerAdressenTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = KolnerAdressenTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
