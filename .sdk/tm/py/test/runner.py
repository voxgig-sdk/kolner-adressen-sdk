...
class KolnerAdressenTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = KolnerAdressenTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = KolnerAdressenTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = KolnerAdressenTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
