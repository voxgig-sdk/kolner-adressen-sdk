...
// KolnerAdressen SDK netsim feature
...
class KolnerAdressenNetsimFeature extends KolnerAdressenBaseFeature
{
    ...
    private function _simulate(KolnerAdressenContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(KolnerAdressenContext $ctx, array $applied): void
    {
        $client = $this->client;
