...
// KolnerAdressen SDK debug feature
...
class KolnerAdressenDebugFeature extends KolnerAdressenBaseFeature
{
    ...
    private function _finish(KolnerAdressenContext $ctx, bool $ok): void
    {
