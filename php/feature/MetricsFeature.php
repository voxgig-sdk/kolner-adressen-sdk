...
// KolnerAdressen SDK metrics feature
...
class KolnerAdressenMetricsFeature extends KolnerAdressenBaseFeature
{
    ...
    private function _record(KolnerAdressenContext $ctx, bool $ok): void
    {
