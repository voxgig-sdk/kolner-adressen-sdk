...
// KolnerAdressen SDK audit feature
...
class KolnerAdressenAuditFeature extends KolnerAdressenBaseFeature
{
    ...
    private function _emit(KolnerAdressenContext $ctx, string $outcome): void
    {
