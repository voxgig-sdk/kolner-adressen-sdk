...
// KolnerAdressen SDK proxy feature
...
class KolnerAdressenProxyFeature extends KolnerAdressenBaseFeature
{
    ...
    public function init(KolnerAdressenContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (KolnerAdressenContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
