...
// KolnerAdressen SDK clienttrack feature
...
class KolnerAdressenClienttrackFeature extends KolnerAdressenBaseFeature
{
    ...
    public function PostConstruct(KolnerAdressenContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'KolnerAdressen-SDK';
