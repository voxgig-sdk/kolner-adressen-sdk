...
// KolnerAdressen SDK ratelimit feature
...
class KolnerAdressenRatelimitFeature extends KolnerAdressenBaseFeature
{
    ...
    private function _acquire(KolnerAdressenContext $ctx): void
    {
    ...
    private function _track(KolnerAdressenContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
