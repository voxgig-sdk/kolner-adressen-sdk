...
// KolnerAdressen SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class KolnerAdressenTransformResponse
{
    public static function call(KolnerAdressenContext $ctx): mixed
    {
        ...
        $transform = KolnerAdressenHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
