...
// KolnerAdressen SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class KolnerAdressenMakeRequest
{
    public static function call(KolnerAdressenContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new KolnerAdressenResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new KolnerAdressenResponse($fetched);
        } else {
