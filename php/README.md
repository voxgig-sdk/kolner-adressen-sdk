# KolnerAdressen PHP SDK



The PHP SDK for the KolnerAdressen API — an entity-oriented client using PHP conventions.
...
```
php/
├── kolneradressen_sdk.php          -- Main SDK class
...
The main class (`kolneradressen_sdk.php`) exports the SDK class
