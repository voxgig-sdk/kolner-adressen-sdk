...
The PHP SDK for the KolnerAdressen API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->Address(null)->list(null, null);
...
[$result, $err] = $client->KolnerAdressen(null)->load(
    ["id" => "test01"], null
);
