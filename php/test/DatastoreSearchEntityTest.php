...
class DatastoreSearchEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set KOLNER_ADRESSEN_TEST_DATASTORE_SEARCH_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function datastore_search_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("KOLNER_ADRESSEN_TEST_DATASTORE_SEARCH_ENTID");
