...
class DatastoreSearchDirectTest extends TestCase
{
    public function test_direct_load_datastore_search(): void
    {
        $setup = datastore_search_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-datastore_search", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
