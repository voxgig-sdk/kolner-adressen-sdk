...
// KolnerAdressen SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (KolnerAdressenSDK::test)
...
{
    private const SDK_CLASS = 'KolnerAdressenSDK';
    ...
    private const SDK_BASE = 'kolneradressen_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../kolneradressen_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
