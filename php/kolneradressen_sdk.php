...
class KolnerAdressenSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = KolnerAdressenHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = KolnerAdressenHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ($utility->feature_add)($this->_rootctx, KolnerAdressenFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return KolnerAdressenUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = KolnerAdressenHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = KolnerAdressenHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = KolnerAdressenHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new KolnerAdressenError($op . "_allow",
                "KolnerAdressenSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = KolnerAdressenHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new KolnerAdressenError("graphql_error",
                "KolnerAdressenSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function DatastoreSearch($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_datastore_search === null) {
                $this->_datastore_search = new DatastoreSearchEntity($this, null);
            }
            return $this->_datastore_search;
        }
        return new DatastoreSearchEntity($this, $data);
    }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new KolnerAdressenSDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
