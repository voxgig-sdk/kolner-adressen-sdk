...
type Args struct {
	Entity string         `json:"entity" jsonschema:"address | datastore_search"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.KolnerAdressenSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "kolner-adressen_list",
		Description: "List records from KolnerAdressen. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "kolner-adressen_load",
		Description: "Load a single record from KolnerAdressen. " +
...
func runOp(client *sdk.KolnerAdressenSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.KolnerAdressenSDK, name string) (sdk.KolnerAdressenEntity, error) {
	switch strings.ToLower(name) {
	case "address":
		return client.Address(nil), nil
	case "datastore_search":
		return client.DatastoreSearch(nil), nil
