// Command KolnerAdressen-mcp is an MCP server exposing the KolnerAdressen
// SDK as MCP tools.
//
// Two tools are registered:
//
//	KolnerAdressen_list  — list records of an entity
//	KolnerAdressen_load  — load a single record of an entity
//
