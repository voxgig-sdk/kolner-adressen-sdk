...
describe("DatastoreSearchDirect", function()
  it("should direct-load-datastore_search", function()
    local setup = datastore_search_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-datastore_search", setup.live and "live" or "unit")
...
function datastore_search_direct_setup(mockres)
