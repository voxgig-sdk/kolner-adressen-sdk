...
function runner.env_override(m)
  local live = runner.getenv("KOLNERADRESSEN_TEST_LIVE")
  local override = runner.getenv("KOLNERADRESSEN_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("KOLNERADRESSEN_TEST_EXPLAIN")
