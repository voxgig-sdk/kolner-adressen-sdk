...
function runner.env_override(m)
  local live = runner.getenv("KOLNER_ADRESSEN_TEST_LIVE")
  local override = runner.getenv("KOLNER_ADRESSEN_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("KOLNER_ADRESSEN_TEST_EXPLAIN")
