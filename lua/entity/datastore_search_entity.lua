...
local DatastoreSearchEntity = {}
DatastoreSearchEntity.__index = DatastoreSearchEntity


function DatastoreSearchEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, DatastoreSearchEntity)
  self._name = "datastore_search"
  self._client = client
...
function DatastoreSearchEntity:get_name()
  return self._name
end


function DatastoreSearchEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return DatastoreSearchEntity.new(self._client, opts)
end
...
function DatastoreSearchEntity:mark_deleted()
  self._deleted = true
end


function DatastoreSearchEntity:deleted()
  return true == self._deleted
end


function DatastoreSearchEntity:data_set(args)
  if args ~= nil then
...
function DatastoreSearchEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function DatastoreSearchEntity:match_set(args)
  if args ~= nil then
...
function DatastoreSearchEntity:match_get()
...
function DatastoreSearchEntity:stream(action, args, callopts)
...
function DatastoreSearchEntity:_run_op(ctx, post_done)
  local utility = self._utility
