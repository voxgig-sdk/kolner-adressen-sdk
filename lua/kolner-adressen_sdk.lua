...
local KolnerAdressenSDK = {}
KolnerAdressenSDK.__index = KolnerAdressenSDK
...
KolnerAdressenSDK._make_feature = _make_feature


function KolnerAdressenSDK.new(options)
  local self = setmetatable({}, KolnerAdressenSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function KolnerAdressenSDK:options_map()
...
function KolnerAdressenSDK:get_utility()
  return Utility.copy(self._utility)
end


function KolnerAdressenSDK:get_root_ctx()
  return self._rootctx
end


function KolnerAdressenSDK:prepare(fetchargs)
...
function KolnerAdressenSDK:direct(fetchargs)
...
-- by passing it.
function KolnerAdressenSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function KolnerAdressenSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "KolnerAdressenSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function KolnerAdressenSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = KolnerAdressenSDK.new(sdkopts)
  sdk.mode = "test"
