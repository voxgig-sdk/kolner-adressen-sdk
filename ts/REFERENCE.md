# KolnerAdressen TypeScript SDK Reference

Complete API reference for the KolnerAdressen TypeScript SDK.
...
```ts
new KolnerAdressenSDK(options?: object)
```
...
#### `KolnerAdressenSDK.test(testopts?, sdkopts?)`
...
**Returns:** `KolnerAdressenSDK` instance in test mode.
...
#### `DatastoreSearch(data?: object)`

Create a new `DatastoreSearch` entity instance.
...
**Returns:** `DatastoreSearchEntity` instance.
...
Alias for `KolnerAdressenSDK.test()`.
...
Return the parent `KolnerAdressenSDK` instance.
