...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.KOLNER_ADRESSEN_TEST_LIVE ||
    'TRUE' === process.env.KOLNER_ADRESSEN_TEST_OVERRIDE
  ) {
  ...
  m.KOLNER_ADRESSEN_TEST_EXPLAIN = process.env.KOLNER_ADRESSEN_TEST_EXPLAIN || m.KOLNER_ADRESSEN_TEST_EXPLAIN
